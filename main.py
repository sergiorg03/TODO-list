...
if __name__ == '__main__':
    ...
    while opcion != 0:
        try:
            ...
            elif opcion == 4: # Eliminamos una tarea
                print(f"{u.listarTareas(listadoTareas=listadoTareas)}")
            ...
            elif opcion == 6: # Marcar tarea como completada
            ...
            elif opcion == 7: # Buscar tarea por categoria o prioridad
                op1 = -1
                while op1 != 0:
                    try:
                        op1 = int(input(
            ...
            else: # Opcion introducida no valida
                print("Opcion no valida. ")
